        ...
        <PageContainer>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <StatsCard label="Sent Campaigns" value={stats.sentCampaigns} icon={<MailCheck size={20} />} colorClass="bg-green-500/40 text-green-400" valueClass="text-green-400" />
                    <StatsCard label="Total Emails Sent" value={stats.totalEmailsSent} icon={<Send size={20} />} colorClass="bg-blue-500/40 text-blue-400" valueClass="text-blue-400" />
                </div>
                                    ...
                                    <tr>
                                        <td colSpan={5} className="p-12 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <p className="text-base font-bold text-white uppercase tracking-widest">No campaigns yet</p>
                                                <button
                                                    onClick={() => router.push("/admin/newsletter/compose")}
                                        ...
                                        <tr key={c.id} className="border-b border-[var(--admin-border)]/50 hover:bg-white/5 transition-colors group">
                                            <td className="p-4">
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    {c.previewText && (
                                                        <span className="text-[11px] text-white truncate max-w-[300px]">{c.previewText}</span>
                                                    )}
                                                </div>
                                            </td>
                                                    ...
                                                    {c.status === "DRAFT" && (
                                                        <>
                                                            <button
                                                                ...
                                                                className="p-2 text-white hover:text-gold hover:bg-gold/10 rounded-[8px] transition-all"
                                                                title="Edit draft"
                                                            >
                                                                <Edit3 size={16} />
                                                            </button>
